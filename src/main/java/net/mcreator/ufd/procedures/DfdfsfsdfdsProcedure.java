...
public class DfdfsfsdfdsProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity, Entity sourceentity) {
		...
		double j = 0;
		double k = 0;
		if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == HotaModItems.THUNDERTRIDENT.get()) {
			{
				Entity _ent = entity;
