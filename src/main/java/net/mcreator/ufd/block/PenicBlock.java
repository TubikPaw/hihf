...
import net.mcreator.ufd.procedures.PenicKoghdaBlokRazrushienIghrokomProcedure;
import net.mcreator.ufd.init.HotaModItems;

public class PenicBlock extends Block {
	public PenicBlock() {
	...
	public boolean onDestroyedByPlayer(BlockState blockstate, Level world, BlockPos pos, Player entity, boolean willHarvest, FluidState fluid) {
		...
		PenicKoghdaBlokRazrushienIghrokomProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
		return retval;
	}
}
