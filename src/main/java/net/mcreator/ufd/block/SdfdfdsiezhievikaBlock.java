...
import net.mcreator.ufd.procedures.EwrgfProcedure;
import net.mcreator.ufd.init.HotaModItems;

public class SdfdfdsiezhievikaBlock extends Block {
	public SdfdfdsiezhievikaBlock() {
	...
	public boolean onDestroyedByPlayer(BlockState blockstate, Level world, BlockPos pos, Player entity, boolean willHarvest, FluidState fluid) {
		...
		EwrgfProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
		return retval;
	}
}
