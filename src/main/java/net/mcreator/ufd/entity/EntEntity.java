...
import net.mcreator.ufd.procedures.EntKoghdaSushchnostUmiraietProcedure;
...
public class EntEntity extends Monster {
	...
	public EntEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HotaModEntities.ENT.get(), world);
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		EntKoghdaSushchnostUmiraietProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
