...
public class VampireEntity extends Monster {
	public VampireEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(HotaModEntities.VAMPIRE.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(HotaModEntities.VAMPIRE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
